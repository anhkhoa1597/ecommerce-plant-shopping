...
function ProductList({ onHomeClick }) {
  ...
  const handleCartClick = (e) => {
    e.preventDefault();
    setShowCart((prev) => !prev); // Set showCart to true when cart icon is clicked
  };
    ...
    <div>
      ...
      {!showCart ? (
        plantsArray.map((category, indexCategory) => (
          <div className="product-grid" key={indexCategory}>
                  ...
                  <div className="product-card" key={indexPlant}>
                    ...
                    <button
                      className={`product-button ${
                        existingItemInCart ? "disabled" : ""
                      }`}
                      onClick={() => handleAddToCart(plant)}
                      disabled={existingItemInCart}
                    >
                      {existingItemInCart ? "Added" : "Add to Cart"}
                    </button>
                  </div>
                );
              })}
